...
export default function ContactPage() {
  useSEO({
    title: helmetConfig.contact.title,
    description: helmetConfig.contact.description,
    keywords: helmetConfig.contact.keywords,
    canonical: helmetConfig.contact.canonical
  });
