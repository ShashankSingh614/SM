...
export const helmetConfig = {
  home: {
    title: 'Shankar Multimedia | Graphic Design, 3D Animation & VFX Institute Mumbai',
    description: 'Join Shankar Multimedia for diploma courses in Graphic Design, UI/UX, Web Development, 3D Animation, VFX & Digital Marketing with 100% job placement. Centers across Mumbai.',
