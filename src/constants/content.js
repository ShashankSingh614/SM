...
export const COURSES_DATA = [
  {
    ...
    description: 'Learn design principles, industry software, and practical project work that helps you build a strong portfolio for jobs, freelance work, and creative careers.',
    image: '/images/courses/gra1.png',
    banner: '/images/courses/gra1.png',
    background: '/images/courses/gra1.png',
    tools: ['Adobe Photoshop', 'CorelDRAW', 'Adobe Illustrator', 'Canva'],
    category: 'Design'
  },
  {
