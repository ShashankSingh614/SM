...
export const COMPANY_INFO = {
  ...
  founder: {
    ...
    image: '/images/team/dharmendra_singh.webp'
  },
...
export const COURSES_DATA = [
  ...
  },
  {
    ...
    background: '/images/courses/DM_bg.webp',
  ...
  },
  {
    ...
    background: '/images/courses/3D_bg.webp',
...
export const HERO_CONTENT = {
  ...
  banners: [
    '/images/courses/all1.webp',
    '/images/courses/gra1.webp',
    '/images/courses/web1.webp',
    '/images/courses/3d1.webp',
    '/images/courses/vfx.webp'
  ],
...
export const MANAGEMENT_TEAM = [
  ...
  },
  {
    ...
    image: '/images/team/saurabh_singh.webp',
  ...
  },
  {
    ...
    image: '/images/team/anurag_singh.webp',
...
export const PLACEMENT_COMPANIES = [
  { id: 1, name: 'Yash Raj Films Studio', logo: '/images/company/1.webp' },
  { id: 2, name: 'Red Chillies Entertainment', logo: '/images/company/2.webp' },
  { id: 3, name: 'IPL', logo: '/images/company/3.webp' },
  { id: 4, name: 'Jio', logo: '/images/company/4.webp' },
  { id: 5, name: 'Nykaa', logo: '/images/company/5.webp' },
  { id: 6, name: 'Cimpress', logo: '/images/company/6.webp' },
  { id: 7, name: 'L&T Infotech', logo: '/images/company/7.webp' },
  { id: 8, name: 'Wipro', logo: '/images/company/8.webp' },
  { id: 9, name: 'Drishyam Films', logo: '/images/company/9.webp' },
  { id: 10, name: 'Zee', logo: '/images/company/10.webp' },
  { id: 11, name: 'Hungama', logo: '/images/company/11.webp' },
  { id: 12, name: 'Dream 11', logo: '/images/company/12.webp' },
  { id: 13, name: 'Accenture', logo: '/images/company/13.webp' },
  { id: 14, name: 'Patni', logo: '/images/company/14.webp' },
  { id: 15, name: 'Lionbridge', logo: '/images/company/15.webp' },
  { id: 16, name: 'Publicis', logo: '/images/company/16.webp'} ,
  { id: 17, name: 'Vistaprint', logo: '/images/company/17.webp' },
  { id: 18, name: 'TATA Consultancy Services', logo: '/images/company/18.webp' },
  { id: 19, name: 'DNEG', logo: '/images/company/19.webp' },
  { id: 20, name: 'Johnson-Johnson', logo: '/images/company/20.webp' },
  { id: 21, name: 'Ogilvy', logo: '/images/company/21.webp' },
  { id: 22, name: 'Saint-Gobain', logo: '/images/company/22.webp' },
  { id: 23, name: 'TATA ELXSI', logo: '/images/company/23.webp' },
  { id: 24, name: 'RenderCAD', logo: '/images/company/24.webp' },
  { id: 25, name: 'Prime Focus Technologies', logo: '/images/company/25.webp' },
  { id: 26, name: 'Cognizant', logo: '/images/company/26.webp' },
  { id: 27, name: 'WITS Interactive', logo: '/images/company/27.webp' },
  { id: 28, name: 'Directi', logo: '/images/company/28.webp' },
  { id: 29, name: 'Reliance Digital', logo: '/images/company/29.webp' },
  { id: 30, name: 'SONY', logo: '/images/company/30.webp' },
  { id: 31, name: 'Indusind Nippon Life Insurance', logo: '/images/company/31.webp' },
  { id: 32, name: 'DMart', logo: '/images/company/32.webp' },
