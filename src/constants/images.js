...
export const COURSE_IMAGES = {
  ...
  '3d': {
    ...
    icon: '/images/courses/3_d.png',
    icon2: '/images/courses/3_d1.png',
  },
  
  // Web Development
  web: {
    background: '/images/courses/DW_bg.png',
    icon: '/images/courses/w_d.png',
    icon2: '/images/courses/w_d1.png',
  },
  
  // Graphic Design
  graphics: {
    background: '/images/courses/PS_bg.png',
    icon: '/images/courses/g_d.png',
    icon2: '/images/courses/g_d1.png',
  },
  
  // PHP Development
  php: {
    background: '/images/courses/php_bg.png',
  },
};
...
export const COURSES_WITH_IMAGES = [
  ...
  },
  {
    ...
    image: COURSE_IMAGES.php.background,
    background: COURSE_IMAGES.php.background,
    category: 'Development',
  },
];
